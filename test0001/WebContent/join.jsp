...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/style.css?ver1.3.1">
	...
	<body>
		...
		<main id="section">
			...
			<table class="table_line">
				...
				<tr>
					<th>회원전화</th>
					<td><input type="text" name="phone"  autofocus ></td>
				</tr>
				<tr>
					<th>회원주소</th>
				...
				<tr>
					<th>가입일자</th>
					<td><input type="text" name="joindate"  autofocus></td>
				</tr>
				<tr>
					<th>고객등급</th>
                    <td><input type="radio" name="grade" value="A" checked>A-VIP 
                        <input type="radio" name="grade" value="B">일반
                        <input type="radio" name="grade" value="C">직원(노예) 
                    </td>
				</tr>
				<tr>
					<th>도시코드</th>
